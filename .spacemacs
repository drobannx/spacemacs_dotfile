...
(defun my-setup-indent (n)
  ...
  (setq javascript-indent-level (* n 2)) ; javascript-mode
  (setq-default js-indent-level (* n 2)) ; js-mode
  (setq-default react-indent-level n)
  (setq-default js2-basic-offset (* n 2)) ; js2-mode, in latest js2-mode, it's alias of js-indent-level
...
(defun setup-mode-per-project ()
  (push '("phoenix.*\\.js\\'" . js2-mode) auto-mode-alist)
  (push '("lantern.*\\.js\\'" . react-mode) auto-mode-alist)
  (push '("mediaman.*\\.js\\'" . react-mode) auto-mode-alist)
  )

(defun setup-flow-type ()
...
you should place your code here."
  (setup-mode-per-project)
  (setq jiralib-url "https://zbrt.atl.zillow.net")
